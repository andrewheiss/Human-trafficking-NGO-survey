...
p <- ggplot(responses.org.foreign, aes(end.time, completed.total))
p + geom_line(colour=bar.color.single, size=2) + 
...
ggsave(p, filename="figures/fig1_3.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig1_3.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig1_4.pdf", width=7.5, height=4, units="in")
ggsave(p, filename="figures/fig1_4.png", width=7.5, height=4, units="in")
p
```
...
ggsave(p, filename="figures/fig1_5.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig1_5.png", width=6.5, height=3, units="in")
p
```
...
p <- ggplot(responses.org.foreign, aes(x=Q2.1/100, y=(..count.. / sum(..count..)))) + 
  ...
  theme_bar
ggsave(p, filename="figures/fig2_1.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig2_1.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig2_2.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig2_2.png", width=6.5, height=3, units="in")
p
```
...
p <- plot.multiple.answers(responses.org.foreign, cols, labels)
ggsave(p, filename="figures/fig2_3.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig2_3.png", width=6.5, height=3, units="in")
p
```
...
p <- plot.multiple.answers(responses.org.foreign, cols, labels)
ggsave(p, filename="figures/fig2_4.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig2_4.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig2_5.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig2_5.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig2_6.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig2_6.png", width=6.5, height=3, units="in")
p
```
...
p <- ggplot(work.countries.plot, aes(map_id=id)) +
  ...
  coord_map(xlim=c(-180,180), ylim=c(-60, 90)) +
  theme_blank_map + theme(legend.key.width=unit(0.55, "line"))
ggsave(p, filename="figures/fig3_2.pdf", width=7.5, height=4, units="in")
ggsave(p, filename="figures/fig3_2.png", width=7.5, height=4, units="in")
p
```
...
ggsave(p, filename="figures/fig3_3.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_3.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig3_4.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_4.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig3_5.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_5.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig3_8.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_8.png", width=6.5, height=3, units="in")
p
```
...
p <- plot.multiple.answers(responses.countries, cols, labels)
ggsave(p, filename="figures/fig3_9.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_9.png", width=6.5, height=3, units="in")
p
```
...
p <- plot.multiple.answers(responses.countries, cols, labels)
ggsave(p, filename="figures/fig3_18.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_18.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig3_19.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_19.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig3_20.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_20.png", width=6.5, height=3, units="in")
p
```
...
p <- plot.multiple.answers(responses.countries, cols, labels)
ggsave(p, filename="figures/fig3_21.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_21.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig3_22.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_22.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig3_23.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_23.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig3_25.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_25.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig3_26.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_26.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig3_27.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_27.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig3_28.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_28.png", width=6.5, height=3, units="in")
p
```
...
ggsave(p, filename="figures/fig3_29.pdf", width=6.5, height=3, units="in")
ggsave(p, filename="figures/fig3_29.png", width=6.5, height=3, units="in")
p
```
