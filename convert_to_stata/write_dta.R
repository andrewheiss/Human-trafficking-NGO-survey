...
responses.orgs <- responses.orgs.raw %>%
  mutate(Q1.3 = factor(Q1.3, labels=c("No", "Yes"), ordered=TRUE),
         home.country = factor(home.country),
         work.only.us = factor(work.only.us, labels=c("No", "Yes"), ordered=TRUE),
         Q1.5.factor = factor(Q1.5.factor, labels=c("1", "2", "3", "4", "5+"),
                              ordered=TRUE),
         Q2.5 = factor(Q2.5, labels=c("No", "Yes"), ordered=TRUE),
         Q2.6 = factor(Q2.6, labels=c("No", "Yes"), ordered=TRUE),
         Q4.2 = factor(Q4.2, labels=c("No", "Yes"), ordered=TRUE),
         Q4.3 = factor(Q4.3, labels=c("No", "Yes"), ordered=TRUE))
